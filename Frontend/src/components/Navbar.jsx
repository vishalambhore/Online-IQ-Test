...
function Navbar() {
    ...
    return (
        <>
            <div className={`max-w-screen-2xl bg-black container mx-auto md:px-20 px-4  fixed top-0 left-0 right-0 z-20 ${sticky
            ...
            >
                <div className="navbar">
                    <div className="navbar-start">
                        ...
                        <a href='/' className="btn btn-ghost text-xl text-white font-serif"> Online IQ Test</a>
                    </div>
                    <div className="navbar-end space-x-3">

                        <div className="navbar-center mr-20 text-white font-serif font-semibold  hidden lg:flex">
                            {/* Navbar Dekstop */}
                        ...
                        <label className="swap swap-rotate">
                            ...
                            {/* sun icon */}
                            <svg
                                className="swap-off h-7 w-7 text-white fill-current"
                                xmlns="http://www.w3.org/2000/svg"
                        ...
                        <a className="bg-blue-700 text-white px-3 py-2 rounded-md hover:bg-green-500 duration-300 cursor-pointer" 
